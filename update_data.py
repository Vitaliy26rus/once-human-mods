...
data = {
    "meta": {
        "game": "Once Human",
        "languages": ["en","ru"],
        "sources": [weapon_url, armor_url, suffixes_url]
    },
    "containers": [
        {
            "id":"weapon_crate",
            "name":{"en":"Weapon Crate","ru":"Ящик с оружейными модами"},
            "description":{"en":"Weapon mods container","ru":"Ящик с оружейными модами"},
            "source": weapon_url
        },
        {
            "id":"gear_crate",
            "name":{"en":"Gear Crate","ru":"Ящик с модами брони"},
            "description":{"en":"Armor mods container","ru":"Ящик с модами брони"},
            "source": armor_url
        }
    ],
